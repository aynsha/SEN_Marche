...
const CatFruiLegum = () => {
  ...
  return (
    <div>
      <Navbar/>
      <section className="  h-[220vh]  justify-center  " >
      <div >
         ...
         <Link to='/inscription'>
         <p className='text-[14px]  mt-[2%] text-primary'>Pommes</p>
         </Link>
         </div>
       </div> 
              <div className=' w-[70%] shadow-lg shadow-gris grid gap-[0px] grid-cols-4 justify-center bg-white ml-[15%]  mt-[10%] rounded-md border-2 border-[#80808039] '>
                {listProduct.filter(product => product.productName.startsWith("Pom")).map(product=>(
                ...
                <h3 className='flex text-[14px] font-semibold w-[100%] gap-[8px] mt-[20px] '>
